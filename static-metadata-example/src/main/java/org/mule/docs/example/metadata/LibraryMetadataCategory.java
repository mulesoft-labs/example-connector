...
import org.mule.docs.example.ExampleStaticMetadataConnector;
...
public class LibraryMetadataCategory {
    ...
    @Inject
    ExampleStaticMetadataConnector connector;

    public void setConnector(ExampleStaticMetadataConnector connector) {
